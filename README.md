...
> Add dynamic moving UI following player position transform

Stage :

> Add fully voiced tutorial stage

Background :

> Fixed the backgroud maps issue by giving distance for each segment
...
- Payload Selection
- Diverse Enemies
- Each Selectable Items had their own stats
- Fully AI-Voiced Tutorial
- Auto-targeting system (For Helicopter)
- Gun Heat System
